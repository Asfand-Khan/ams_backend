...
exports.shiftUpdateSchema = exports.shiftSchema = void 0;
...
exports.shiftSchema = zod_1.z
    ...
    early_leave_threshold_minutes: zod_1.z
        ...
        .default(30),
    break_duration_minutes: zod_1.z
        .number({
...
//     }
//   );
exports.shiftUpdateSchema = exports.shiftSchema.extend({
    shift_id: zod_1.z
        .number({
